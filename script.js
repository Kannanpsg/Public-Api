...
app.controller("studentCtrl" , ["$scope",function($scope) {
	$scope.data = [
	{ Name : "Michael", country_id : "IT", Country : "ITALY", probility: "0.5970"},
	{ Name : "Matheww", country_id : "ES", Country : "SPAIN", probility : "0.0897"},
	{ Name : "hayden", country_id : "TR", Country : "TURKEY", probility : "0.0997"},
	{ Name : "matlee", country_id : "DE", Country : "GERMANY", probility : "0.1097"}
	];
}]);
...
input_.style.margin = "0px 10px 10px 80px";
